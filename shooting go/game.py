...
class Game:
    ...
    def __init__(self):
        self.score_song = pygame.mixer.Sound('sprites/score.mp3')
        self.shot_song = pygame.mixer.Sound('sprites/shot.wav')
        self.end_game_song = pygame.mixer.Sound('sprites/soccer_crowd.mp3')
        ...
        self.victory_font = pygame.font.Font('sprites/PressStart2P.ttf', 44)
    ...
    def run(self):
        ...
        while self.game_loop:
            ...
            if self.score_a >= 2 or self.score_b >= 2:
