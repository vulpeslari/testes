...
class Score:
    def __init__(self, score_a, weight,height, color):
        self.scoreA = score_a
        self.color = color
        self.font = pygame.font.Font("PressStart2P.ttf", 40)
        self.score_point_player = self.font.render(f"{self.scoreA}", True, color)
        self.score_point_player_rect = self.score_point_player.get_rect(center=(weight, height))
